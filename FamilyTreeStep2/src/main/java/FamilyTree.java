public class FamilyTree {
    ...
    public void addPartner(String name, Integer identifier) throws AlreadyHasPartnerException{
        ...
        // Display structure when partner is added
        System.out.println(getCurrent());
    }
    ...
    public String findFamilyMemberID(Integer inputId) throws IdentifierNotFoundException{
        String familyMemberDetails;
        FamilyTreeNode familyMember;
        FamilyTreeNode child;
        if (inputId == this.ancestor.identifier){
            ...
            familyMember = this.checkPartnerID(inputId, this.ancestor);
            if(familyMember == null){
    ...
    // Used to check the partner for the findFamilyMember method
    private FamilyTreeNode checkPartnerID(Integer inputID, FamilyTreeNode familyMember){
        familyMember = familyMember.partner;
        Boolean searching = familyMember != null;
        while (searching) {
            if (inputID == familyMember.identifier){
